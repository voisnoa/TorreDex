          ...
          >
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-1 shadow-lg">
              <button
                ...
                className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl font-bold text-white w-full bg-white hover:bg-gray-50"
              >
                <Search size={20} />
                Start Searching
              </button>
  ...
  return (
    <div className="rounded-3xl shadow-2xl mx-4 sm:mx-0 overflow-hidden">
      ...
      <div className="p-8 bg-white">
        <div className="mb-8">
          <h3 className="font-bold text-2xl mb-6 text-black">Get recommendations for:</h3>
            ...
            {selectedPeople.map((person) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p 
                    className={`text-base truncate text-gray-600`}
                  >
                    @{person.username}
                  </p>
                  {person.verified && (
      ...
      <div className="p-8 bg-gradient-to-b from-gray-50 to-gray-100">
        {isLoading && (
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-bold mb-3 text-black">Finding Recommendations</h3>
            <p className="text-gray-600">Analyzing professional networks and skills...</p>
          </div>
        )}

        {error && (
          <div className="text-center py-16 bg-white rounded-3xl p-10 shadow-xl">
            ...
            <h3 className="text-2xl font-bold mb-3 text-black">Error</h3>
        ...
        {!isLoading && !error && !recommendations.recommendations && selectedPeople.length > 0 && (
          <div className="text-center py-16 bg-white rounded-3xl p-10 shadow-xl">
            ...
            <h3 className="text-2xl font-bold mb-3 text-black">Ready for Recommendations</h3>
            ...
            >
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-1 shadow-lg">
                <button
                  ...
                  className="px-6 py-3 bg-white text-indigo-600 rounded-2xl font-bold hover:bg-gray-50 transition-all"
                >
              ...
              <div className="rounded-3xl p-7 bg-white shadow-xl">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-3 bg-green-50 rounded-2xl px-5 py-3">
...
const RecommendationCard = ({ recommendation, index, onViewGenome }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <p className="text-gray-700 mb-5 line-clamp-2 text-lg">
        ...
        <div className="space-y-3 mb-7">
          <h4 className="font-bold text-lg text-black">Why Recommended:</h4>
